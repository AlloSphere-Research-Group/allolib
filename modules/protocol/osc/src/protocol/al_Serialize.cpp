...
Deserializer::Deserializer(const char* b, uint32_t n) : mStart(0) {
...
uint32_t serDecode(const char* b, void* data) {
  ...
  switch (h.type) {
    ...
    case SER_INT32:
    case SER_UINT32:
      r += serCopy4(data, b + SOH, h.num);
      break;
    case SER_FLOAT64:
    case SER_INT64:
    case SER_UINT64:
      r += serCopy8(data, b + SOH, h.num);
      break;
    case SER_INT8:
    case SER_UINT8:
      r += serCopy1(data, b + SOH, h.num);
      break;
    case SER_INT16:
    case SER_UINT16:
      r += serCopy2(data, b + SOH, h.num);
      break;
    default:;
  }
  return r;
