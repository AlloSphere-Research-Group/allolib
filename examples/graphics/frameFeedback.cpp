...
public:
	...
	// 2. Draw feedback texture. Try the different varieties!
		...
		// g.quad(texBlur, -1, -1, 2, 2);

		// Outward feedback
		g.quad(texBlur, -1.005, -1.005, 2.01, 2.01);

		// Inward feedback
		// g.quad(texBlur, -0.995, -0.995, 1.99, 1.99);

		// Oblate feedback
		// g.quad(texBlur, -1.005, -1.00, 2.01, 2.0);

		// Squeeze feedback!
		// g.quad(texBlur, -1.005, -0.995, 2.01, 1.99);
