...
struct MyApp : App
{
    ...
    void updateFBO(int w, int h) {
        ...
        texDepth.create2D(w / 4, h / 4,
            Texture::DEPTH_COMPONENT16, Texture::DEPTH_COMPONENT, Texture::UBYTE);
    ...
    void onDraw(Graphics& g) {
        g.depthTesting(true); // the depth buffer is not updated if the depth test is disabled
