...
along the z axis left arrow		turn left right arrow		turn
right up arrow		turn up down arrow		turn down
  ...
  bool onKeyDown(const Keyboard& k) override {
    ...
    switch (k.key()) {
      ...
      case 'n':
        ...
        break;
      case '.':
        std::cout << "Pressed period.\n" << std::endl;
        break;
      case ' ':
        std::cout << "Pressed space bar.\n" << std::endl;
        break;
  ...
  bool onMouseDown(const Mouse& m) override {
    switch (m.button()) {
      ...
      case Mouse::RIGHT:
        ...
        break;
      case Mouse::MIDDLE:
        std::cout << "Pressed middle mouse button.\n" << std::endl;
        break;
      default:
...
int main() {
  ...
  app.fps(40);
  app.configureAudio(44100, 128, 2, 1);  // rate, block, output, input
  app.start();
  return 0;
}
