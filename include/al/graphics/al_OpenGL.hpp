...
inline void cullFaceFront () { faceCulling(true); faceToCull(GL_FRONT); }
inline void cullFaceBack () { faceCulling(true); faceToCull(GL_BACK); }
inline void cullFaceBoth () { faceCulling(true); faceToCull(GL_FRONT_AND_BACK); }
